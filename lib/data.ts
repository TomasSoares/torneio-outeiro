...
export const PLAYERS: Record<string, Player> = {
  p1:  { id: 'p1',  name: 'Tiago Mendes',    team: 'CRV' },
  p2:  { id: 'p2',  name: 'Vasco Pinto',     team: 'CRV' },
  p10: { id: 'p10', name: 'André Gonçalves', team: 'CRV' },
  p7:  { id: 'p7',  name: 'Miguel Tavares',  team: 'LAM' },
  p11: { id: 'p11', name: 'Rafael Gomes',    team: 'LAM' },
  p15: { id: 'p15', name: 'Pedro Faria',     team: 'ACP' },
  p8:  { id: 'p8',  name: 'Diogo Almeida',   team: 'ERI' },
  p3:  { id: 'p3',  name: 'João Pereira',    team: 'AOT' },
  p9:  { id: 'p9',  name: 'Francisco Neves', team: 'AOT' },
  p12: { id: 'p12', name: 'Hugo Sampaio',    team: 'AOT' },
  p4:  { id: 'p4',  name: 'Rui Santos',      team: 'SVL' },
  p13: { id: 'p13', name: 'Filipe Cunha',    team: 'SVL' },
  p14: { id: 'p14', name: 'Nuno Carmo',      team: 'SVL' },
  p5:  { id: 'p5',  name: 'Bruno Costa',     team: 'CDP' },
  p16: { id: 'p16', name: 'Sérgio Pacheco',  team: 'CDP' },
  p6:  { id: 'p6',  name: 'Henrique Lopes',  team: 'RFC' },
  p17: { id: 'p17', name: 'Daniel Ferraz',   team: 'RFC' },
};
