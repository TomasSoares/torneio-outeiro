...
export const INITIAL_MATCHES: Match[] = [
  ...
  { id: 'm1',  jornada: 1, group: 'A', round: null, date: '2026-05-04', time: '17:00', home: 'CRV', away: 'LAM', played: true,  hs: 2, as: 1, venue: 'Campo Municipal',
    scorers: [ {p:'p1', t:'CRV', c:1, min:23}, {p:'p2', t:'CRV', c:1, min:67}, {p:'p7', t:'LAM', c:1, min:81} ] },
  { id: 'm2',  jornada: 1, group: 'A', round: null, date: '2026-05-04', time: '19:00', home: 'ACP', away: 'ERI', played: true,  hs: 0, as: 0, venue: 'Campo Municipal', scorers: [] },
  { id: 'm3',  jornada: 1, group: 'B', round: null, date: '2026-05-04', time: '17:00', home: 'AOT', away: 'SVL', played: true,  hs: 2, as: 2, venue: 'Campo da Ribeira',
    scorers: [ {p:'p3', t:'AOT', c:1, min:12}, {p:'p9', t:'AOT', c:1, min:55}, {p:'p4', t:'SVL', c:1, min:33}, {p:'p13', t:'SVL', c:1, min:88} ] },
  { id: 'm4',  jornada: 1, group: 'B', round: null, date: '2026-05-04', time: '19:00', home: 'CDP', away: 'RFC', played: true,  hs: 1, as: 0, venue: 'Campo da Ribeira',
    scorers: [ {p:'p5', t:'CDP', c:1, min:71} ] },

  // Jornada 2 — 11 Maio 2026
  { id: 'm5',  jornada: 2, group: 'A', round: null, date: '2026-05-11', time: '17:00', home: 'CRV', away: 'ACP', played: true,  hs: 3, as: 0, venue: 'Campo Municipal',
    scorers: [ {p:'p1', t:'CRV', c:2, min:15}, {p:'p1', t:'CRV', c:1, min:48}, {p:'p10', t:'CRV', c:1, min:74} ] },
  { id: 'm6',  jornada: 2, group: 'A', round: null, date: '2026-05-11', time: '19:00', home: 'LAM', away: 'ERI', played: true,  hs: 1, as: 2, venue: 'Campo Municipal',
    scorers: [ {p:'p11', t:'LAM', c:1, min:29}, {p:'p8', t:'ERI', c:1, min:52}, {p:'p8', t:'ERI', c:1, min:79} ] },
  { id: 'm7',  jornada: 2, group: 'B', round: null, date: '2026-05-11', time: '17:00', home: 'AOT', away: 'CDP', played: true,  hs: 4, as: 1, venue: 'Campo da Ribeira',
    scorers: [ {p:'p3', t:'AOT', c:2, min:8}, {p:'p3', t:'AOT', c:1, min:62}, {p:'p9', t:'AOT', c:1, min:34}, {p:'p12', t:'AOT', c:1, min:90}, {p:'p5', t:'CDP', c:1, min:55} ] },
  { id: 'm8',  jornada: 2, group: 'B', round: null, date: '2026-05-11', time: '19:00', home: 'SVL', away: 'RFC', played: true,  hs: 1, as: 1, venue: 'Campo da Ribeira',
    scorers: [ {p:'p14', t:'SVL', c:1, min:40}, {p:'p6', t:'RFC', c:1, min:83} ] },

  // Jornada 3 — 18 Maio 2026
  { id: 'm9',  jornada: 3, group: 'A', round: null, date: '2026-05-18', time: '17:00', home: 'CRV', away: 'ERI', played: false, hs: null, as: null, venue: 'Campo Municipal', scorers: [] },
  { id: 'm10', jornada: 3, group: 'A', round: null, date: '2026-05-18', time: '19:00', home: 'LAM', away: 'ACP', played: false, hs: null, as: null, venue: 'Campo Municipal', scorers: [] },
  { id: 'm11', jornada: 3, group: 'B', round: null, date: '2026-05-18', time: '17:00', home: 'AOT', away: 'RFC', played: false, hs: null, as: null, venue: 'Campo da Ribeira', scorers: [] },
  { id: 'm12', jornada: 3, group: 'B', round: null, date: '2026-05-18', time: '19:00', home: 'SVL', away: 'CDP', played: false, hs: null, as: null, venue: 'Campo da Ribeira', scorers: [] },
];
